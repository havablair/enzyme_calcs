...
corr_test <- mub_std_test %>% 
  ...
  nest(std_data = c(plate_blank, id, mub_std_mean, n, corr_std_mean, conc_uM))
...
quench_nested <- quench_test %>% 
  ...
  nest(quench_data = c(mub_soil_blank, conc_uM, mub_soil_std_mean, n, corr_std_mean))
...
quench_lm_details <- nest_emis_details %>% 
...
nest_quench_stats$lm_stats_emis
```
